 ...
 */
// write your code here
var names: [String] = ["Doug", "Danny", "Tara", "Michael"]
func groupGreeting (a: [String]) {
    for name in a {
        if name == "Michael" {
...
func numsLessThanFifty  (a: [Int]) -> [Int] {
    var newArray: [Int] = []
    for num in a {
        if num < 50 {
            newArray.append(num)
